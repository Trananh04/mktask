 ...
 *
 * Options:
 *   --source   Source SVG file path (default: assets/logo/mktask-logo.svg)
...
const DEFAULT_SOURCE = path.join(ROOT_DIR, 'assets/logo/mktask-logo.svg');
...
const ICON_SIZES = [
  ...
  { name: 'mktask-logo.png', size: 512, description: 'mktask Logo' },
];
