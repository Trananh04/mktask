# AGENTS.md - mktask AI Agent Configuration

This document provides guidance for AI agents working with the mktask project, including development setup, testing, and code quality standards.

## Project Overview

mktask is an open-source project management platform with conversational AI task execution. It's built as a monorepo with:
...
When working on mktask as an AI agent:
...
- GitHub Issues: https://github.com/mktask/mktask/issues
- GitHub Discussions: https://github.com/mktask/mktask/discussions
