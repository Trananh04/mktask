# mktask - Open Source Project Management with Conversational AI Task Execution

![Logo](https://raw.githubusercontent.com/mktask/mktask/main/frontend/public/taskosaur-logo.png)
...
[![License](https://img.shields.io/badge/license-BSL-blue.svg)](https://github.com/mktask/mktask/blob/main/LICENSE.md)

**Official Docker image for mktask** - An open source project management platform with conversational AI for task execution in-app that lets you manage projects through natural conversation directly within the application.
...
mktask is a self-hosted project management platform that combines traditional PM features with conversational AI for task execution in-app. The AI assistant performs actions directly in your browser through natural conversation. Instead of clicking through forms and menus, simply describe what you need in natural language.
...
After starting mktask, enable conversational AI for in-app task execution:
...
- **GitHub**: https://github.com/mktask/mktask
- **Documentation**: https://github.com/mktask/mktask#readme
- **Issues**: https://github.com/mktask/mktask/issues
...
- GitHub Issues: [Report bugs](https://github.com/mktask/mktask/issues)

---

**Built by the mktask team** | Licensed under Business Source License
