# Contributing to mktask

Thank you for your interest in contributing to mktask! We welcome contributions from the community and are grateful for your help in making this project better.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/mktask/taskosaur.git
   cd taskosaur
   ```
...
### Code Contributions
- Check existing [issues](https://github.com/mktask/taskosaur/issues) for good first issues
...
- **Discussions**: [GitHub Discussions](https://github.com/mktask/taskosaur/discussions)
- **Issues**: [GitHub Issues](https://github.com/mktask/taskosaur/issues)
...
- Open a [Discussion](https://github.com/mktask/taskosaur/discussions)
- Create an issue with the `question` label
- Reach out via email

Thank you for contributing to mktask!