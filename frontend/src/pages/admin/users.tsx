...
// System roles for the internal app.
const ALL_ROLES = ["SUPER_ADMIN", "MANAGER", "MEMBER"];
                        ...
                        <DropdownMenuContent align="end" className="border-none bg-[var(--popover)] shadow-lg min-w-[180px] p-1">
                          ...
                          {user.role !== "SUPER_ADMIN" && user.role !== "MANAGER" && (
                            <DropdownMenuItem
                              ...
                              className="flex items-center gap-2 px-2.5 py-2 rounded-md cursor-pointer transition-all duration-150 hover:bg-[var(--accent)]"
                            >
                              <HiShieldCheck className="w-3.5 h-3.5 text-orange-500" />
                              <span className="text-sm">{t("users.actions.promote_manager", "Nâng lên Manager") as string}</span>
                            </DropdownMenuItem>
                          )}
                          {user.role === "MANAGER" && (
                            <DropdownMenuItem
                            ...
                            >
                              <HiShieldExclamation className="w-3.5 h-3.5 text-orange-500" />
                              <span className="text-sm">{t("users.actions.demote_member", "Hạ xuống Member") as string}</span>
                            </DropdownMenuItem>
                          )}
                          <DropdownMenuSeparator className="my-1" />
                          <DropdownMenuItem
