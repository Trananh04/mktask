        ...
        <div className="space-y-8">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none space-y-6">
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                By accessing and using mktask ("the Service"), you accept and agree to be bound
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                mktask provides a comprehensive project management and collaboration platform
                that includes:
              </p>
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                To the maximum extent permitted by law, mktask shall not be liable for any
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                You agree to indemnify and hold harmless mktask and its affiliates, officers,
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                jurisdiction in which mktask operates, without regard to its conflict of law
                provisions.
              </p>
            </section>
          ...
          <div className="pt-8 border-t">
            <p className="text-center text-sm text-muted-foreground">
              By using mktask, you acknowledge that you have read and understood these Terms of
