          ...
          <div className="prose prose-gray dark:prose-invert max-w-none space-y-6">
            <section className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                At mktask, we take your privacy seriously. This Privacy Policy explains how we
            ...
            <section className="space-y-4">
              ...
              <div className="pl-6 space-y-1 text-muted-foreground">
                <p>Email: privacy@mktask.vn</p>
                <p>Data Protection Officer: dpo@mktask.vn</p>
              </div>
            </section>
          </div>
          ...
          <div className="pt-8 border-t">
            <div className="space-y-4">
              <p className="text-center text-sm text-muted-foreground">
                By using mktask, you acknowledge that you have read and understood this Privacy
                Policy.
              </p>
              <p className="text-center text-sm text-muted-foreground">
                View our{" "}
