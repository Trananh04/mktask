...
// MCP Server configuration for mktask context
...
export interface MCPTool {
  ...
  description: string;
  parameters?: any;
  execute: (params: any, context: MktaskContext) => Promise<any>;
}

class MCPServer {
  private context: MktaskContext = {};
  ...
  updateContext(updates: Partial<MktaskContext>) {
...
export function extractContextFromPath(pathname: string): Partial<MktaskContext> {
  const context: Partial<MktaskContext> = {};
