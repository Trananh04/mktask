...
export class UniversalSearchService {
  ...
  private async searchProjects(
    ...
    return projects.map((project) => ({
      ...
      url: `/${project.workspace.slug}/${project.slug}`,
      context: {
  ...
  private async searchTasks(
    ...
    return tasks.map((task) => ({
      ...
      url: `/${task.project.workspace.slug}/${task.project.slug}/tasks/${task.slug}`,
      context: {
  ...
  private async searchComments(
    ...
    return comments.map((comment) => ({
      ...
      url: `/${comment.task.project.workspace.slug}/${comment.task.project.slug}/tasks/${comment.task.slug}#comment-${comment.id}`,
      context: {
  ...
  private async searchSprints(
    ...
    return sprints.map((sprint) => ({
      ...
      url: `/${sprint.project.workspace.slug}/${sprint.project.slug}/sprints/${sprint.id}`,
      context: {
  ...
  private async searchLabels(
    ...
    return labels.map((label) => ({
      ...
      url: `/${label.project.workspace.slug}/${label.project.slug}/labels/${label.id}`,
      context: {
