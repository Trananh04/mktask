...
export class EmailProcessor implements OnModuleInit {
  ...
  async handleSendEmail(job: IJob<EmailJobData>) {
    ...
    const smtpFrom = await this.getSmtpConfig('smtp_from', 'SMTP_FROM', 'noreply@mktask.vn');
    ...
    switch (template) {
      case EmailTemplate.TASK_ASSIGNED:
        bodyContent = `
           <div class="container">
            ...
            <div class="footer">
              <p>mktask - Quản lý dự án hiện đại</p>
            </div>
          </div>
        `;
        break;
      ...
      case EmailTemplate.PASSWORD_RESET:
        bodyContent = `
          <div class="container">
            <div class="content">
              <p>Đã có yêu cầu đặt lại mật khẩu cho tài khoản mktask của bạn.</p>
      ...
      case EmailTemplate.PASSWORD_RESET_CONFIRMATION:
        ...
        <div class="container">
          <div class="content">
            <p>Mật khẩu tài khoản mktask của bạn đã được đặt lại thành công.</p>
            ...
            <div class="info-section">
              <p>If you didn't authorize this change, contact support immediately at ${data.supportEmail || 'support@mktask.vn'}</p>
            </div>
          </div>
          <div class="footer">
            <p>mktask - Quản lý dự án hiện đại</p>
        ...
        <div style="max-width:560px;margin:0 auto;padding:40px 0;">
          <div style="padding:0 20px;">
            ...
            <p style="font-size:15px;color:#1d1d1f;margin:0 0 16px;">
              ...
              <strong>${data.entityName}</strong> on mktask as a <strong>${data.role}</strong>.
            </p>
            ...
            <p style="font-size:12px;color:#86868b;margin:0;">
              mktask &mdash; Project Management
            </p>
          </div>
        </div>
      `;
      ...
      case EmailTemplate.WORKSPACE_INVITED:
        bodyContent = `
          <div class="container">
            <div class="content">
              <p>Bạn đã được mời tham gia một không gian làm việc trên mktask.</p>
      ...
      default:
        bodyContent = `
          <div class="container">
            <div class="content">
              <p>Bạn có một thông báo mới từ mktask.</p>
...
mktask - Quản lý dự án hiện đại
      ...
      case EmailTemplate.PASSWORD_RESET:
        return `
Đặt lại mật khẩu mktask

Hi ${data.userName}!

We received a request to reset your mktask account password.
...
Bạn đã được mời tham gia một không gian làm việc trên mktask.
...
${data.inviterName} has invited you to join ${data.entityName} on mktask as a ${data.role}.
