...
export class AiChatService {
  ...
  private generateSystemPrompt(): string {
    return `You are mktask AI assistant for browser automation.Your job is to help users automate tasks on web pages.
...
RESPONSE RULES:
- For greetings (hi, hello, hey): DONE: Xin chào! Hôm nay tôi có thể hỗ trợ bạn với mktask như thế nào?
- For off-topic/non-app requests: DONE: I can only help with mktask tasks like creating tasks, projects, filtering, etc.
